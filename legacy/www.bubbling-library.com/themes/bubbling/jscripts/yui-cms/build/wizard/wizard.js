  ...
  var $L = YAHOO.lang,
	...
	*/
    YAHOO.plugin.WizardManager = function() {
		...
		function fetch( area, m, uri, c) {
			// set the loading class to the area...
			$D.addClass(area.element, _loadingClass);
			uri = $DP.firewall (uri, area);
			area.handle = $C.asyncRequest(m, uri, c);
		}
...
YAHOO.register("wizard", YAHOO.plugin.WizardManager, {version: "1.5.0", build: "217"});