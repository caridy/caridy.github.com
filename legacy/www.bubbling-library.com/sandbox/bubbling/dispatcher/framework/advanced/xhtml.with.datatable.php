...
<div id="dynamic-datatable-simple">
	<div id="hd">
    <h1>DataTable Widget :: Basic Table</h1>
	...
	<p>
		...
		- The datatable.css was also loaded by the dispatcher using the CSS injection feature.<br />
	</p>
  </div>
  <div id="bd">
