...
yuidoc_home=~/repository/yuidoc
 
# The location of the files to parse. Parses subdirectories, but will fail if
# there are duplicate file names in these directories. You can specify multiple
# source trees:
# parser_in="%HOME/www/yui/src %HOME/www/event/src"
parser_in=~/repository/yui3-gallery/src/gallery-node-accordion/js
 
# The location to output the parser data. This output is a file containing a
# json string, and copies of the parsed files.
parser_out=~/repository/yuidoc/parser/gallery-node-accordion
 
# The directory to put the html file outputted by the generator
generator_out=~/repository/caridy.github.com/api/gallery-node-accordion
