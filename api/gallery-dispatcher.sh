...
parser_in=~/repository/yui3-gallery/src/gallery-dispatcher/js
 
# The location to output the parser data. This output is a file containing a
# json string, and copies of the parsed files.
parser_out=~/repository/yuidoc/parser/gallery-dispatcher
 
# The directory to put the html file outputted by the generator
generator_out=~/repository/caridy.github.com/api/gallery-dispatcher
